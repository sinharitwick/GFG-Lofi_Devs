...
function Contact() {
  return (
    <div name='contact' className='w-full h-screen bg-[#e3e3e3] flex justify-center items-center p-4'>
        <Fade bottom>
        <form action="https://getform.io/f/225ffde8-777b-456c-afc5-56e323ec0b65" method='POST' className='flex flex-col max-w-[600px] w-full'>
            ...
            <button className="border-2 flex px-4 py-3 my-4 mx-auto border-[#000000] items-center hover:border-[#155705] duration-300">Submit</button>
        </form>
        </Fade>
    </div>
  )
